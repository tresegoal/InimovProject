...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.produits.store']]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('priceHT', old('priceHT'), ['class' => 'form-control', 'required' => 'required']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('quantity', old('description'), ['class' => 'form-control', 'required' => 'required']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::number('tva', old('description'), ['class' => 'form-control', 'required' => 'required']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('tva'))
                        <p class="help-block">
                            {{ $errors->first('tva') }}
